...
<head>
	...
	<link rel="stylesheet" type="text/css" href="/static/css/workshops.css">
  ...
  <div class="row" id="row">
    <div class="col-12" id="col">
		<div class="content" id="ct">
      	<h3>Python Workshop by 3M</h3>
		<hr>
		<span style="font-size:12px;font-color:light-gray">Partipate and get Hands on Experience</span><br><br>

		<button href="#" id="button">Register</button>
		</div>	
	</div>
	</div>
	<br><br>
    ...
    <div class="col-12" id="col">
		<div class="content" id="ct">
      	<h3>Cisco Networking Workshop</h3>
		<hr>
		<span style="font-size:12px;font-color:light-gray">Partipate and get Hands on Experience</span><br><br>
		<button href="#" id="button">Register</button>
		</div>	

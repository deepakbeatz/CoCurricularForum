  ...
  <div class="row" id="row">
    <div class="col-12" id="col">
		<div class="content" id="ct">
      	<h3>CodeNation Contest</h3>
		<hr>
		<span style="font-size:12px;font-color:light-gray">congratulations to all winners!</span><br><br>
		Results:<br><br>
		1st: NagaGokul<br>
		2nd: Rahul Singh<br>
		3rd: Sarat Chandra<br>
		</div>	
	</div>
	</div>
	<br><br>
